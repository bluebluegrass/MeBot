...
def build_prompt(query: str, retrieved_context: str, requested_format: str) -> str:
    ...
    return (
        ...
        "1. Identify the strongest recurring ideas, scenes, and observations in the sources"
        " -- ignore any newsletter greetings, issue numbers, sending context, or promotional copy.\n"
        "2. Draft in Chinese using only those grounded ideas and scenes,"
        " written fresh for the requested format and topic.\n"
